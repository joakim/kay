...
In short: A cell is the synthesis of object, block and function, implemented as a reference type with built-in persistence. The runtime environment is the stem.
