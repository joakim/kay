...
One characteristic that plants and apps have in common is that they are immobile, in contrast to animals. Apps running on a mobile device is like taking a potted plant for a walk. Plant cells may therefore be a more suitable model for computing than animal cells, at least for now.
