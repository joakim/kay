...
Cells are by default [encapsulated and opaque](https://en.wikipedia.org/wiki/Information_hiding). The internal state may only be accessed from the outside through messages. Any exceptions are handled internally, a cell can not crash.
