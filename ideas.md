...
One characteristic that plants and apps have in common is that they are usually in a fixed position (on the network), in contrast to animals that move around. A mobile device running apps is like taking a potted plant for a walk. Plant cells may therefore be a more suitable model than animal cells.
