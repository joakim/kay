...
<b title="Too long; didn't read">TL;DR:</b> A cell is the synthesis of object, method and block, implemented as a first-class reference type with built-in persistence, communicating by message signaling. Encapsulated, safe. The runtime is the stem.
